...
class INIPARSERSHARED_EXPORT IniParser
{
public:
    // Construct IniParser and parse given filename. See ini.h for more info
    // about the parsing.
    explicit IniParser(const std::string& filename);

    // Construct IniParser and parse given buffer. See ini.h for more info
    // about the parsing.
